...
function DirectoryNav($h, config) {
    this.opts = $.extend(true, {
        ...
        scrollTopBorder: 0,    //滚动条距离顶部多少的时候显示导航，如果为0，则一直显示 100
        easing: 'swing',        //不解释
...
DirectoryNav.prototype = {
    ...
    make: function () {
        ...
        $("#frog_sidebar").append('<div class="directory-nav" id="directoryNav"><ul></ul><span class="cur-tag"></span><span class="c-top"></span><span class="c-bottom"></span><span class="line"></span></div>');
        var $hs = this.$h,
