...
package com.demo.utils.fastDfs;
...
public class ClientGlobal {
   ...
   */
  public static void init(String conf_filename) throws IOException, Exception {
   ...
   *                      server之间用逗号','分隔
   */
  public static void initByProperties(String propsFilePath) throws IOException, Exception {
  ...
  public static void initByProperties(Properties props) throws IOException, Exception {
    ...
    if (trackerServersConf == null || trackerServersConf.trim().length() == 0) {
      throw new Exception(String.format("configure item %s is required", PROP_KEY_TRACKER_SERVERS));
    }
   ...
   *                       server之间用逗号','分隔
   */
  public static void initByTrackers(String trackerServers) throws IOException, Exception {
  ...
  public static void initByTrackers(InetSocketAddress[] trackerAddresses) throws IOException, Exception {
